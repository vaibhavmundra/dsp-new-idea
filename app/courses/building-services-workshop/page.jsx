...
const sessions = [
  {
    ...
    covering:
      "Electrical Core Concepts | Wall Electricals: DBs, Sockets, Switches, Conduits",
  },
  {
    date: "2025-01-25",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "RCP, Lighting, and Looping best practices | Making Electrical Layouts",
  },
  {
    date: "2025-01-26",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "Water Supply: Concepts, Fittings, Pipes, Tanks | Domestic vs Commercial Systems ",
  },
  {
    date: "2025-01-30",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "Water Drainage: Concepts, Fittings, Pipes, Chambers | Making Plumbing Layouts",
  },
  {
    date: "2025-01-31",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "HVAC: Split and VRF | Tonnage Calculation | Site Best Practices | Layout",
  },
  {
    date: "2025-02-01",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering: "CCTV, Data, Security, Automation | CCTV & Data Layout",
  },
  {
    date: "2025-02-02",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering: "Class Project Review | Discussions & Wrap Up",
  },
];
...
const course_id = 15;
const selling = true;
const name = "Electrical, Plumbing, and HVAC Masterclass";

export const metadata = {
  title: name,
  description:
    "Develop a practical understanding, explore best practices, and learn step by step the professional drawing systems for Electrical, Plumbing, and Allied Services.",
  openGraph: {
    images: [
      {
        ...
        <div className="p-5 mb-12 absolute top-1/2 transform -translate-y-1/2 z-10">
          <div className="mx-auto flex flex-col items-center text-center md:w-3/4">
            ...
            <p className="mb-12 opacity-60 text-lg">
              Develop a practical understanding, explore best practices, and
              learn step by step the professional drawing systems for
              Electrical, Plumbing, and Allied Services.
            </p>
            <div className="flex items-center p-1 border border-lightGrey rounded-full backdrop-blur-[2px] relative z-20 overflow-hidden">
              <div className="px-5 text-left font-medium text-xs md:text-base">
                <p>24th Jan-2nd Feb, 2025</p>
                <p>
                  <span className="line-through">INR 5999</span> INR{" "}
                ...
                <div className="grid auto-rows-max gap-4">
                  ...
                  <div className="">
                    <div className="mb-2 flex items-center">
                      ...
                      <h4 className="text-lg ml-2">07 sessions</h4>
                    </div>
                    <div className="opacity-50 text-sm">
                      The workshop will be held over 07 sessions
                    </div>
                  </div>
                </div>
              </div>
              <div>
                ...
                <ul className="grid grid-rows-6 gap-4">
                  <li className="flex items-center">
                    ...
                    <p className="ml-2">
                      You will learn the core concepts of electrical supply like
                      conduiting, wire thickness, looping, switch boards, etc.
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Learn step by step how to draft Ceiling and Wall
                      Electrical Layouts
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      You will learn the core concepts of plumbing like pipe
                      thickness, traps, fittings, chambers, etc.
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Learn step by step how to draft Water Supply and Drainage
                      Layouts
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Learn core concepts and drafting of Air Conditioning
                      Layouts
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Class Project: Apply all this learning in a{" "}
                      <span className="font-semibold">2BHK Residence</span> we
                      will work on together to solidify your skills
                    </p>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-32 md:mb-64 px-5">
          <div className="container mx-auto">
            <div className="mb-16">
              ...
              <p className="mb-12 opacity-60 text-lg">
                This workshop consists of 07 live sessions
              </p>
            </div>
              ...
              <div className="md:col-span-1 mx-auto border border-borderGrey rounded-3xl flex flex-col items-start overflow-hidden">
                ...
                <div className="pb-10 pt-5 px-5">
                  <div className="flex items-start mb-4">
                    <p className="text-2xl">Neha Bhasin</p>
                    <a
                      className="ml-2"
                      href="https://www.linkedin.com/in/arneha-bhasin/"
                      target="_blank"
                    >
                  ...
                  <p className="opacity-50 text-sm">
                    Architect and Mechanical, Electrical, and Plumbing (MEP)
                    Specialist,
                    <br></br> Principal Architect, Pramana Design Studios,
                    <br></br> MEP Specialist, Intelligent Building Consultants
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-2 flex flex-col justify-between md:pl-8">
                ...
                <div>
                  <p className="md:text-xl opacity-50">
                    ...
                    Studio, specializing in MEP Design and Project Management.
                    She serves as a Guest Lecturer at AAFT. Neha also works
                    part-time as an MEP Specialist at Intelligent Building
                    Consultants Services, focusing on integrated building
                    designs. She previously lectured at IVS School of Design.
                    She has an extensive experience of 9 years in project
                    implementation, budgeting, and MEP, based in New Delhi,
                    India.
                  </p>
                </div>
              </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Review
                ...
                text="I found the coursed to be a good balance between theory and practical knowledge of Ar Preetha Deepak. The training covered all the aspects of PM in complete detail with lots of practical examples, most importantly relevant to our Indian context. I recommend the training to all the professionals of our field."
                courseType="Workshop"
                courseName="How to Manage Interior Projects"
