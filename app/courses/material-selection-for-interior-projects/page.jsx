...
const sessions = [
  {
    ...
    covering:
      "Introduction | Material issues and challenges posed in a live project",
  },
  {
    date: "2025-02-08",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      " Live project example | How to make a moodboard | Deep dive: Tiles",
  },
  {
    date: "2025-02-09",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "Case study: Anh Chi Restaurant | Exploring hard materials: boards, panels, and stones ",
  },
  {
    date: "2025-02-14",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "Deep dive: Fabrics | Aesthetics: How materials interact with light | Deep dive: Paints",
  },
  {
    date: "2025-02-15",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering:
      "Materials and sustainibility | Exploring new upcoming materials",
  },
  {
    date: "2025-02-16",
    sessions: [{ start: "19:00", end: "21:00" }],
    covering: "Materials and site context | Other common materials | Conclusion",
  },
];

console.log(formattedDateLong(sessions[0].date));
...
const course_id = 16;
const selling = true;
const name = "Materials Masterclass for Interior Projects";

export const metadata = {
  title: name,
  description:
    "Develop a practical understanding, explore best practices, and learn how to effectively use contemporary materials in your design projects",
  openGraph: {
    images: [
      {
      ...
      >
        ...
        <div className="p-5 mb-12 absolute top-1/2 transform -translate-y-1/2 z-10">
          <div className="mx-auto flex flex-col items-center text-center md:w-3/4">
            ...
            Develop the practical understanding, explore best practices, and learn how to effectively use contemporary materials in your design projects
            </p>
                ...
                <div className="grid auto-rows-max gap-4">
                  ...
                  <div className="">
                    <div className="mb-2 flex items-center">
                      ...
                      <h4 className="text-lg ml-2">06 sessions</h4>
                    </div>
                    <div className="opacity-50 text-sm">
                      The workshop will be held over 06 sessions
                    </div>
                  </div>
                </div>
              </div>
              <div>
                ...
                <ul className="grid grid-rows-6 gap-4">
                  <li className="flex items-center">
                    ...
                    <p className="ml-2">
                      How to select materials that suit the ambience of the proposed space
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                    Understand common interior materials in depth
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Common site challenges and mistakes to avoid
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Explore sustainability & discover futuristic materials
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Best practices to select materials at stores/with clients
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Learn how to make{" "}
                      <span className="font-semibold">mood and concept boards</span>
                    </p>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-32 md:mb-64 px-5">
          <div className="container mx-auto">
            <div className="mb-16">
              ...
              <p className="mb-12 opacity-60 text-lg">
                This workshop consists of 06 live sessions
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="md:col-span-1 mx-auto border border-borderGrey rounded-3xl flex flex-col items-start overflow-hidden">
                ...
                <div className="pb-10 pt-5 px-5">
                  <div className="flex items-start mb-4">
                    <p className="text-2xl">Joitree Debnath</p>
                    <a
                      className="ml-2"
                      href="https://in.linkedin.com/in/joitree-debnath-960a7a137"
                      target="_blank"
                    >
              ...
              <div className="md:col-span-2 flex flex-col justify-between md:pl-8">
                ...
                <div>
                  ...
                  Born and raised in Calcutta, Joitree draws inspiration from the vibrant culture of her homeland, seamlessly weaving its rich heritage into her creative work. After earning her degree in design, she honed her skills with prominent designers and emerging studios, gaining invaluable industry experience. 
                  <br></br>
                  <br></br>
                  Specializing in high-end luxury residential and conceptual commercial spaces, Joitree focuses on crafting environments that captivate and elevate user experiences. The studio embraces a design philosophy that marries cultural authenticity with contemporary contrasts, creating spaces that are both evocative and modern.
                  </p>
                </div>
              </div>
            </div>
