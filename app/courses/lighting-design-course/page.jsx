...
const sessions = [
  {
    ...
    covering:
      "Introduction | Important concepts of lighting design",
  },
  {
    date: "2025-11-22",
    sessions: [{ start: "19:00", end: "21:30"  }],
    covering:
      "Hands on exercise on: Make a concept layout | How to select light fixtures",
  },
  {
    date: "2025-11-23",
    sessions: [{ start: "19:00", end: "21:30"  }],
    covering:
      "Hands on exercise: Making a complete light package | Automation | Conclusion",
  }
];
...
const course_id = 28;
const selling = true;
const name = "Lighting Design for Interior Projects";

export const metadata = {
  title: name,
  description:
    "Develop the critical professional skill of creating functional and aesthetic lighting schemes for interior projects.",
  openGraph: {
    images: [
      {
              ...
              <div>
                ...
                <ul className="grid grid-rows-6 gap-4">
                  <li className="flex items-center">
                    ...
                    <p className="ml-2">
                    How to quickly estimate the amount of lighting required for various spaces
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                    Understand various types of fixtures available in the market and how to select them
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                    How to place lighting fixtures in the plan, their distances and other considerations.
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                    How to create multiple light circuits in a space for various requirements
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                      Understand home automation and how it can be implemented
                    </p>
                  </li>
                  <li className="flex items-center">
                    <CheckCircleIcon className="w-6 h-6 text-orange/70 flex-shrink-0" />
                    <p className="ml-2">
                    Explore how all of this comes together in{" "}
                      <span className="font-semibold">case studies and hands on exercises.</span>
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="md:col-span-1 mx-auto border border-borderGrey rounded-3xl flex flex-col items-start overflow-hidden">
                ...
                <div className="pb-10 pt-5 px-5">
                  <div className="flex items-start mb-4">
                    <p className="text-2xl">M Jnanasagar Kamath</p>
                    <a
                      className="ml-2"
                      href="https://www.linkedin.com/in/jskamath/"
                      target="_blank"
                    >
                  ...
                  Lead Lighting Consultant,
                    <br></br> Masters in Lighting Design,
                    <br></br>Politecnico di Milano, Milan, Italy
                    <br></br>6+ years of experience
              ...
              <div className="md:col-span-2 flex flex-col justify-between md:pl-8">
                ...
                <div>
                  ...
                  ​M Jnanasagar Kamath is a lighting consultant based in Bangalore, with over six years of experience in the lighting industry. He holds a Masters degree from Politecnico di Milano and a Bachelor of Engineering from Visvesvaraya Technological University. His professional journey includes roles such as Lighting Designer at Architectural Lighting Concepts Pvt Ltd (November 2021 – July 2022), Engineer in Lighting Solutions and Specifications at RIPPL Lighting (October 2020 – November 2021), and Executive Lighting Designer at The Defa (August 2019 – October 2020). Currently he works as a Lead Lighting Designer at QR-Pixel Design Studio.
                  </p>
                </div>
              </div>
            </div>
